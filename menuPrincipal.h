...
private:
    ...
    // PRE: -
    // POS: devuelve un puntero en otro espacio de memoria (heap) con los mismos datos que el personaje pasado por parametro
    Personaje* clonarPersonaje(Personaje* personaje);
